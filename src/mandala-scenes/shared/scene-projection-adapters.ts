...
const sceneProjectionBuilders: Record<
    Exclude<SceneRendererKind, 'card-scene'>,
...
export const buildLegacySceneProjection = (
    ...
    sceneKey.variant === 'week-7x9'
        ...
        : sceneKey.viewKind === 'nx9'
          ...
          : sceneProjectionBuilders[
                resolveSceneRendererKind(sceneKey) as Exclude<
                    SceneRendererKind,
                    'card-scene'
                >
            ](sceneKey, props);
...
export const buildSceneProjection = ({
    ...
    preparedThreeByThreeDayPlanProps,
    ...
    preparedThreeByThreeDayPlanProps: ThreeByThreeDayPlanSceneProjectionProps;
    committedThreeByThreeDayPlanProps: ThreeByThreeDayPlanSceneProjectionProps;
    nx9WeekProps: Nx9WeekSceneProjectionProps;
    nx9Props: Nx9SceneProjection['props'];
}): SceneProjection =>
    sceneKey.viewKind === '3x3' && sceneKey.variant === 'day-plan'
        ? buildThreeByThreeDayPlanSceneProjection({
              sceneKey,
              committedSceneKey,
              preparedProps: preparedThreeByThreeDayPlanProps,
              committedProps: committedThreeByThreeDayPlanProps,
          })
